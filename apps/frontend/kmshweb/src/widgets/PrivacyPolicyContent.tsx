  ...
  return (
    <div className="">
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Coffee Roll, the software
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Coffee Roll.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Coffee Roll, accessible from{" "}
            <a
              href="https://kmshweb.com"
      ...
      <h3>Background Data Updates</h3>
      <p>
        We may update or synchronize Your Personal Data in the background, even
        when You are not actively using the Service. This may include refreshing
        Your account information, preferences, or other data to ensure that the
        Service remains up-to-date and functions correctly.
      </p>
      <p>
        The background updates help us provide a seamless and consistent user
        experience across devices and over time.
      </p>
      <p>
        If You prefer not to have Your data updated automatically in the
        background, You may adjust Your settings in the Service or contact Us to
      ...
      <ul>
        <li>By email: coffeeroll901@gmail.com</li>
      </ul>
    </div>
  );
};
